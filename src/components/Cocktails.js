...
//       <div className="cocktails-grid">
//         {cocktails.map((cocktail) => (
//           <div key={cocktail.idDrink} className="cocktail-item" onClick={() => fetchCocktailDetailsById(cocktail.idDrink)}>
//             <img src={cocktail.strDrinkThumb} alt={cocktail.strDrink} className="cocktail-image" />
//             <h3 className="cocktail-name">{cocktail.strDrink}</h3>
//             <p className="cocktail-category">{cocktail.strCategory}</p>
//           </div>
...
//       <div className="cocktails-grid">
//         {cocktails.map((cocktail) => (
//           <div key={cocktail.idDrink} className="cocktail-item" onClick={() => fetchCocktailsByIngredient(cocktail.strIngredient1)}>
//             <img src={cocktail.strDrinkThumb} alt={cocktail.strDrink} className="cocktail-image" />
//             <h3 className="cocktail-name">{cocktail.strDrink}</h3>
//             <p className="cocktail-category">{cocktail.strCategory}</p>
//           </div>
